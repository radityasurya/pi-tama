 ...
 * all producing the same `SubagentSession` shape.
 *
 * Wired implementation (in ./backends/):
 * - pi: real in-process `createAgentSession()` via the pi SDK.
 * - stub: scripted sessions for tests.
 */
